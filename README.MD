...
A 1k script that allows applications to listen for a `long-press` event on any HTML element. Defaults to 1.5 seconds but can be overridden by adding a `data-long-press-delay="3000"` attribute to an element.
